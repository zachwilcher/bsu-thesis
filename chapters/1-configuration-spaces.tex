...
\begin{proof}
    ...
    % Why is simple connectedness topological?
    ...
    \[
        ...
        \end{cases}
    \]
    % Probably should ensure F is continuous ...
    % Pasting lemma theorem 18.3 pg. 108 of Munkres is surely satisfied.
    % Also, it seems clear that F(U,1) is actually S^{n-1} by construction but further elaboration might be nice.
    ...
    % We use here that the fundemental group is preserved under homotopy
    % Lemma 55.1 page 348 of Munkres?

    % Also, might be nice to say why B_2 \ {q} is not simply connected since it retracts to S^1
\end{proof}
