...
As remarked earlier, the proofs in this section are essentially repeated applications of Lemma \ref{lem:is_surface_1}.
This next Lemma takes that to the extreme by determining ``from the ground up'' exactly what kind
of graphs we could have if their configuration spaces are \(2\)-manifolds without boundary.

% TODO do we need n \ge 3?
